...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue2_collapse__ = __webpack_require__(6);
var _elemento;
  ...
  methods: {
    ...
    guardar: function guardar() {
      ...
      if (!this.validar()) {
        ...
        document.querySelectorAll('checkbox-atributos').forEach(function (item, key) {
    ...
    cargarImagenesMiniaturas: function cargarImagenesMiniaturas(key) {
      var i = 1;
      if (key == 'null') {
    ...
    cargarImagenALienzo: function cargarImagenALienzo(tipo) {
      ...
      this.mensajeError = '';
      this.mensajeOk = '';
      if (document) var canvas = document.getElementById('canvas');
