  	    ...
  	    @foreach ($publicaciones as $publicacion)
  	      <div class="col-md-4" style="margin-bottom:20px">
  	        <div class="block span4">
  	          ...
  	          <div class="info">
  	            <h5 style="text-overflow:ellipsis;overflow:hidden;white-space:nowrap;"> {{ $publicacion->titulo }}</h5>
                ...
                <h6 style="text-overflow:ellipsis;overflow:hidden;white-space:nowrap;">Por: <strong>{{ $publicacion->user->name }}</strong></h6>
