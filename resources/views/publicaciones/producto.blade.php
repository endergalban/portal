        ...
        <div class="col-lg-9">
          ...
          <div class="card card-outline-secondary my-4" >
            ...
            <div class="card-body">
              ...
              <small class="text-muted">Posteado por {{$comentario->user->name}} el {{date('d-m-Y', strtotime($comentario->created_at))}}</small>
              <br><br>
